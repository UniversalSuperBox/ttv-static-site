...
## This is the last event in the Closet's current form!

String Theory Studio in Chippewa Falls, the host of the Closet, is closing its doors at the end of January. We cannot thank the team at String Theory enough for their contributions to Transforming the Valley and the Closet over the years.

Because of this change in host, this may be the final Closet event for some time. We are still figuring out what to do with the Closet's current stock and how to continue to provide this valuable service to the Chippewa Valley. Future events will be announced on this page, CVLGBT's email newsletter, on the CVLGBTQ Community Center's Discord server, and other CVLGBTQ channels.

We are not currently accepting clothing donations due to this change.

If you'd like to contact us about the event, please email [chair@transformingthevalley.org](mailto:chair@transformingthevalley.org) or join the CVLGBTQ Community Center's Discord server using the link at [cvlgbt.org](https://cvlgbt.org).

## When

Our final event at String Theory is scheduled for January 24th and 25th, 2026.
